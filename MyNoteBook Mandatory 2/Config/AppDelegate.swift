...
//
//  Created by Jakob Wulff on 18/02/2019.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let startMainVC = storyboard.instantiateViewController(withIdentifier: "Table")
        let startSigninVC = storyboard.instantiateViewController(withIdentifier: "Signin")
